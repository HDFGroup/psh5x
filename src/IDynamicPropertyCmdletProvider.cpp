...
#pragma region sanity check
			...
			src_path_str = (char*) Marshal::StringToHGlobalAuto(sourcePath).ToPointer();
			dst_path_str = (char*) Marshal::StringToHGlobalAuto(destinationPath).ToPointer();
			src_attr_name_str = (char*) Marshal::StringToHGlobalAuto(sourceProperty).ToPointer();
			dst_attr_name_str = (char*) Marshal::StringToHGlobalAuto(destinationProperty).ToPointer();
...
#pragma endregion
        ...
        String^ destinationPath, String^ destinationProperty)
    {
		...
		// TODO: implement as copy followed by remove
